...
//   </div>
<div style={{ backgroundColor: "#C9C9C9", padding: "2px 0", display: "flex", alignItems: "center", justifyContent: "space-between", marginTop:"50px" }}>
<div style={{ marginLeft: "20px", fontSize: "12px", color:"#444444" }}>
@2024 kirdi-ver-IV
</div>
<div style={{ marginRight: "20px", fontSize: "14px", display: "flex", alignItems: "center", color:"gray" }}>
Handcrafted by  <strong style={{ color: "#007bff" }}> Nikhil Pillare</strong>
